...
pub fn process(
   ...
   let (mint1_key, mint1_bump) = Pubkey::find_program_address(
       &[
           b"mint",
           mint1.key.as_ref(),
       ],
   ...
   let (mint2_key, mint2_bump) = Pubkey::find_program_address(
       &[
           b"mint",
           mint2.key.as_ref(),
       ],
...
//    assert_eq!(*mint1.key, mint1_key);
//    assert_eq!(*mint2.key, mint2_key);
...
//            program_id
//        ),
//        &[admin_signer_account.clone(), mint1.clone(), system_program.clone()],
//        &[&[b"mint", mint1.key.as_ref(), &[mint1_bump]]]
//    )?;
...
//            program_id
//        ),
//        &[admin_signer_account.clone(), mint2.clone(), system_program.clone()],
//        &[&[b"mint", mint1.key.as_ref(), &[mint2_bump]]]
//    )?;
   ...
   invoke_signed(
       &token_instruction::initialize_mint(
        ...
        &[&[b"exchange_booth", admin_signer_account.key.as_ref()]]
    )?;
...
//            None,
//            9)?,
//        &[mint2.clone(), admin_signer_account.clone(), system_program.clone()],
//    )?;
